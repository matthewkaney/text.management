...
shape([4, 8, 6, 8].fast(3), k3(0.3, 0.6))
  .invert(1)
...
osc(12, 2).rotate(PI/2)
  .thresh(0.5)
  .kaleid([4, 20, 8].fast(4))
  // .kaleid(6)
  .rotate(t(2))
  .invert([0, 1].fast(2))
  .out(o2)
...
osc(10, 0.2, 0.1)
  ...
  // .color(1, 0.8, 0)
  .kaleid(20)
  .rotate([0, PI / 8].fast(8))
  .out(o1);

osc(15, [0.1, -0.1].fast(4))
  .thresh()
  .blend(src(o1).color(0.4, 1, 0.2))
  .contrast(2)
  .color(0.8, 0.5, 0.2)
  .add(osc(15, [0.1, -0.1].fast(4)).rotate(PI/2))
  .out(o1);

voronoi(20, 3)
  .colorama([20, 22, 31].fast(9))
  .hue(t(0.2))
  .out(o1)
...
osc(8, 1.2)
  .thresh()
  .kaleid(20)
  .modulate(noise(), [0.1, 0.4, 0.8, 0.2, 2].fast(4))
  .color(0, 1, 0.4)
  .out(o2)

osc(10, 0.7)
  .rotate([0, PI/2].ease().fast(4))
  .thresh(0.9)
  .modulate(noise(2), 2)
  .out(o2);
...
noise(8, 0.1)
  .brightness(-0.2)
  .color(1, 0.2, 0.1)
  .add(noise(8, 0.1).thresh(0.7).color(1, 0.5, 0.2))
  .add(src(o2).scale(0.99).rotate(0.001), 0.8)
  .out(o2);
